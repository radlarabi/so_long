...
/*   Updated: 2023/01/22 14:28:56 by rlarabi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    t_image_data *i_data = malloc(sizeof(t_image_data));
    i_data->coin = init_coins();
    i_data->fire = init_fire();
    i_data->game = map;
    i_data->mlx = mlx_init();
    i_data->mlx_win = mlx_new_window(i_data->mlx, map.width * 50, map.height * 50 ,"so_long");
